...
from tracker.jdecmc import jdecmc
...
def eval_seq(opt, dataloader, data_type, result_filename, save_dir=None, show_image=True, frame_rate=30, use_cuda=True):
    ...
    tracker = jdecmc(opt, frame_rate=frame_rate)
    timer = Timer()
    results = []
    frame_id = 0
...
if __name__ == '__main__':
    ...
    if opt.val_dance:
        seqs_str = '''dancetrack0004
                      ...
                      dancetrack0030
                     '''
        data_root = os.path.join(opt.data_dir, '/root/userfolder/jdecmc/src/lib/datasets/dataset/val')
    if opt.val_mot15:
        seqs_str = '''Venice-2
                      KITTI-13
                      KITTI-17
