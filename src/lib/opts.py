...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--val_dance', default=False, help='dancetrack')
    ...
    self.parser.add_argument('--data_cfg', type=str,
                             default='..//src/lib/cfg/data2.json',
                             help='load data from cfg')
    self.parser.add_argument('--data_dir', type=str, default='/root/userfolder/FairMOT/src/lib/datasets/dataset')
    ...
    self.parser.add_argument("--cmc-method", default="cmc", type=str, help="cmc method: files (Vidstab GMC) | sparseOptFlow | orb | ecc | none")
